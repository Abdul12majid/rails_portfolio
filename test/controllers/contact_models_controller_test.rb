...
class ContactModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_model" do
    assert_difference("ContactModel.count") do
      post contact_models_url, params: { contact_model: { email: @contact_model.email, message: @contact_model.message, name: @contact_model.name } }
    end
  ...
  test "should update contact_model" do
    patch contact_model_url(@contact_model), params: { contact_model: { email: @contact_model.email, message: @contact_model.message, name: @contact_model.name } }
